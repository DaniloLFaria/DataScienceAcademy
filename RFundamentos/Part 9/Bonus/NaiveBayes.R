...
setwd("~/Dropbox/DSA/BigDataAnalytics-R-Azure/Cap09/Bonus")
getwd()
...
# Funcao que retorna o numeros de NA's por voto e classe (democrat or republican)
...
# Funcao para executar o registrar todos os resultados do modelo
...
# Os resultados das execuções estão bem próximos, entre 0.82 e 0.92, com um desvio padrão de 0.03.
